...
class TemplateManager:
    ...
    def load_all_templates(self) -> None:
        ...
        if not self.health_templates:
            raise TemplateLoadError(
                str(self.images_path), "No health templates loaded! Check your images folder."
            )
    ...
    def _handle_template_load_failure(self, filepath: Path, filename: str, percentage: str) -> None:
