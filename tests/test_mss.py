...
TEMPLATE_CONFIG = [
    *[ {"name": f"{pct}% Health", "file": f"{pct}_health_bar.png", "th": 0.85}
       for pct in ["20","40","50","70","90","full"] ],
    {"name": "Empty Health",      "file": "empty_health_bar.png",     "th": 0.80},
    {"name": "Left Empty Health", "file": "left_empty_health_bar.png","th": 0.80},
    {"name": "Respawn Button",    "file": "respawn_button.png",       "th": 0.80},
    {"name": "Mob Health",        "file": "mob_full_health_bar.png",   "th": 0.75},
    {"name": "Object Yang",       "file": "object_yang.png",          "th": 0.75},
    {"name": "Health Potion v1",  "file": "object_health_pot.png",    "th": 0.75},
    {"name": "Health Potion v2",  "file": "object_health_pot_v2.png", "th": 0.75},
    {"name": "Auto Hunt Start",   "file": "auto_hunt_start_button.png","th": 0.75},
]
...
def main_loop():
    ...
    while True:
        ...
        for cfg in templates:
            ...
            overlay_lines.append(f"{name}: {score:.2f}")
        ...
        prev_time = now
        cv2.putText(
            disp, f"FPS: {fps:.1f}", (5, disp.shape[0] - 10),
